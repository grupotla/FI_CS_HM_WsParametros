...
public class Utils
{
    ...
    public static string EscribirEnDirectorio(string path, string filename, string texto)
    {
        ...
        try
        {
            ...
            if (Directory.Exists(path))
            {
                ...
                System.IO.File.AppendAllText(path + "\\" + filename, texto + Environment.NewLine);
        ...
        {
            return "Ha habido un error al intentar escribir " + errorC.Message;
        }
    }
