    ...
    public static Struct.ArrParams EmpresaParametros(string pais, string sistema, string docid, string titulo, string edicion)
    {
        ...
        try
        {
            ...
            */
            ...
            if (Params.titulo != null)
                if (Params.titulo.Trim() == "") Params.titulo = "No se configuro titulo";
        }
        catch (Exception e)
        {
...
WHERE a.activo = true AND a.pais_iso = '" + empresa + "'";
    ...
    /*
    public static NpgsqlConnection OpenPostgresConnection_BK(string tipo)
    {
        ...
        try
        {
            ...
            switch (tipo)
            {
                ...
                case "master-aimar":
                    db = "master-aimar";
                    strconn = "Server=10.10.1.20;Port=5432;User Id=dbmaster;Password=aimargt;Database=" + db + ";POOLING=True;MINPOOLSIZE=2;MAXPOOLSIZE=1000;CommandTimeout=5000;";
                    break;
                ...
                case "pruebas _":
                    db = "pruebas _master-aimar";
                    strconn = "Server=10.10.1.20;Port=5432;User Id=dbmaster;Password=aimargt;Database=" + db + ";POOLING=True;MINPOOLSIZE=2;MAXPOOLSIZE=1000;CommandTimeout=5000;";
                    break;

                case "local":
                    db = "master-aimar";
                    strconn = "Server=localhost;Port=5432;User Id=postgres;Password=adminpass;Database=" + db + ";POOLING=True;MINPOOLSIZE=2;MAXPOOLSIZE=1000;CommandTimeout=5000;";
                    break;

                default:
                    strconn = "Server=10.10.1.20;Port=5432;User Id=dbmaster;Password=aimargt;Database=" + tipo + ";POOLING=True;MINPOOLSIZE=2;MAXPOOLSIZE=1000;CommandTimeout=5000;";
                    break;
            }
    ...
    */
    ...
    #endregion OpenPostgresConnection_BK
